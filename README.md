...
| 维度 | 权重 | 指标 |
|------|------|------|
| 趋势评分 | 25% | 均线排列（MA5/MA20/MA60）、价格相对位置、均线斜率 |
| 动量评分 | 20% | RSI 强弱指标、MACD 信号、近期涨跌幅 |
| 波动率评分 | 15% | 年化波动率、布林带宽度 |
| 成交量评分 | 20% | 量比（5日/20日）、量价配合度、成交趋势 |
| 价值评分 | 20% | 距52周高低点位置、近期支撑强度 |

**AI大模型评分**（腾讯混元2.0 Think）：
- 技术面解读：结合行情数据综合判断
- 行业/基本面：房地产政策环境、公司经营推断
- 资金面分析：成交量变化反映的市场态度
- 风险评估：识别潜在风险，给出操作建议
